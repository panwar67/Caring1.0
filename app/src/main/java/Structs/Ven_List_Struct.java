...
/**
 * Created by Panwar on 10/02/17.
 */
public class Ven_List_Struct
{
    ...
    public static String Ven_Assure = "VEN_ASSURE";
    public static String Ven_Url = "VEN_URL";
    public static String Ven_No_Img = "VEN_NO_IMG";
    public static String Ven_Lat = "VEN_LAT";
